...
$(function () {
  ...
  scrollInit();
  //   setTimeout(() => {
  //       $(".menu-position-side.menu-side-left.full-screen").perfectScrollbar()
  //   }, 3000);
  //   $(document).ready(
  //   );
  $(".sendBtn").click(() => {
  ...
  if (
    ...
    if ($("#liteLineChartV3").length) {
      ...
      let da = v.attr("data-chart-data");
      var k = [12, 28, 19, 24, 43, 49, 40, 35, 42, 46, 38];
